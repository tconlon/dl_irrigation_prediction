...
def deploy_predictions(args, dltile_key):
    ...
    import os
    from descarteslabs.catalog import Product, Image, OverviewResampler
    from scripts.utils import (load_model_from_dlstorage, load_normalization_from_dlstorage,
                               compile_model_clean_standardization)
...
def deploy_on_tasks(args):
    docker_image = 'gcr.io/dl-solutions-dev/terry_conlon/'\
    'py37_tf220_au@sha256:116f2ff85de630f62411702d22c27fb976fa7f229d0357aec1044b2c94e32201'
...
if __name__ == '__main__':
    ...
    deploy_predictions(args, dltile_key)